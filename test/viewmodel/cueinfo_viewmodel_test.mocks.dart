...
// in unflacgui/test/viewmodel/cueinfo_viewmodel_test.dart.
...
import 'package:unflacgui/parser/cue_info.dart' as _i9;
import 'package:unflacgui/parser/cue_parser.dart' as _i6;
import 'package:unflacgui/parser/file_info.dart' as _i7;
import 'package:unflacgui/parser/track_info.dart' as _i8;
...
/// A class which mocks [CueParser].
///
/// See the documentation for Mockito's code generation for more information.
class MockCueParser extends _i1.Mock implements _i6.CueParser {
  MockCueParser() {
    _i1.throwOnMissingStub(this);
  }

  @override
  bool get trackIsOpen =>
      (super.noSuchMethod(Invocation.getter(#trackIsOpen), returnValue: false)
          as bool);
  @override
  bool get cueInfoTitleSettled =>
      (super.noSuchMethod(Invocation.getter(#cueInfoTitleSettled),
          returnValue: false) as bool);
  @override
  set cueInfoTitleSettled(bool? _cueInfoTitleSettled) => super.noSuchMethod(
      Invocation.setter(#cueInfoTitleSettled, _cueInfoTitleSettled),
      returnValueForMissingStub: null);
  @override
  set currentParsingFile(_i7.FileInfo? _currentParsingFile) => super
      .noSuchMethod(Invocation.setter(#currentParsingFile, _currentParsingFile),
          returnValueForMissingStub: null);
  @override
  set currentTrackInfo(_i8.TrackInfo? _currentTrackInfo) => super.noSuchMethod(
      Invocation.setter(#currentTrackInfo, _currentTrackInfo),
      returnValueForMissingStub: null);
  @override
  _i9.CueInfo? parse(_i2.File? cueFile) =>
      (super.noSuchMethod(Invocation.method(#parse, [cueFile]))
          as _i9.CueInfo?);
}
